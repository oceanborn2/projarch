...
<!--
   ...
   $Id: Todolist.xsl,v 1.1 2002/05/28 21:03:32 munerot Exp $
   $Log: Todolist.xsl,v $
...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" reference-orientation="90">
    ...
    <fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block margin-left="0pt" margin-right="0pt" font="bold 14pt Helvetica"
                  ...
                  >The Project Architect - Todo list</fo:block>
...
<xsl:template match="Todo">
	...
	<fo:list-item-label   end-indent="label-end()"><fo:block font-family="ZapfDingbats">â</fo:block></fo:list-item-label>
	 <fo:list-item-body start-indent="body-start()"><fo:block><xsl:value-of select="@date-submitted"/>:<xsl:value-of select="@submitted-by"/> - <xsl:value-of select="@email"/> - <xsl:value-of select="@category"/></fo:block></fo:list-item-body>
 	</fo:list-item>
        </fo:list-block>
